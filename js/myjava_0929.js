...
{    
    $.ajax({
        ...
        success: function(jsonp) {
            /*
            $("#pageContainer .prev").html(jsonp.p_prev_content);
            if (jsonp.p_prev_content != "") $("#pageContainer .prev").removeClass().addClass("p"+(curPage-1)).addClass("pages");
            $("#pageContainer .current").html(jsonp.p_now_content);
            $("#pageContainer .current").addClass("p"+curPage);
            $("#pageContainer .next").html(jsonp.p_next_content);
            if (jsonp.p_next_content != "") $("#pageContainer .next").removeClass().addClass("p"+(curPage+1)).addClass("pages");
            if (jsonp.p_prev_content == "") $("#pageContainer .prev").removeClass("pages");
            if (jsonp.p_next_content == "") $("#pageContainer .next").removeClass("pages");
            */
           //alert(jsonp.length)
...
function setPage(){
    ...
    //$("#pageContainer").load(function() {  $("#pageContainer .current").children().hide().fadeIn("slow");});
    /*

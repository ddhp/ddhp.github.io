  ...
  App.Lines = [
    {
      ...
      options: ["Emboss Roll", "Lamination Unit"],
      ...
      types: ["Vacuum / Mechanical", "Single / Multi lane"],
      options: ["Kraft Paper Bander"],
      ...
      options: ["Steel to Steel / Steel to Ruber Emboss Roll", "Lamination Unit", "Kraft Paper Bander", "Log Saw"],
...
(function() {
  ...
  App.ContactRoute = Ember.Route.extend({
    ...
    activate: function() {
      ...
      return apiDiv.appendChild(script);
    }
  });
...
function program3(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\" type=\"text/javascript\" charset=\"utf-8\"></script>\n  </head>\n  <body>\n  <!-- livereload of grunt -->\n  ");
  stack1 = helpers.unless.call(depth0, "production", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program1(depth0,data) {
  ...
  var buffer = '', stack1;
  data.buffer.push("\n<h5>Options</h5>\n");
  stack1 = helpers.each.call(depth0, "option", "in", "options", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(2, program2, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  return buffer;
  }
function program2(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</dt>\n  ");
  stack1 = helpers.each.call(depth0, "list", "in", "option.lists", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</dl>\n\n");
  return buffer;
  }
...
function program5(depth0,data) {
  ...
  data.buffer.push("</p>\n\n");
  stack1 = helpers['if'].call(depth0, "options", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program4(depth0,data) {
  ...
  var buffer = '', stack1, helper, options;
  data.buffer.push("\n      <li>\n        ");
  stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']),options={hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "id", options) : helperMissing.call(depth0, "link-to", "id", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </li>\n      ");
  return buffer;
  }
function program5(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      ");
  stack1 = helpers.each.call(depth0, "pages", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n    </ul>\n  </div><!-- /.navbar-collapse -->\n</div><!-- /.container-fluid -->\n</nav>\n");
  return buffer;
